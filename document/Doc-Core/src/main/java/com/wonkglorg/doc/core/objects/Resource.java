...
public record Resource(Path resourcePath, LocalDateTime createdAt, String createdBy, LocalDateTime modifiedAt,
                       String modifiedBy, RepoId repoId,
                       String commitId, boolean isEditable, String category, String data) {
    ...
    public Resource(Path resourcePath, String creator, RepoId repoId, String commitId, boolean isEditable, String data) {
        this(resourcePath, LocalDateTime.now(), creator, LocalDateTime.now(), creator, repoId, commitId, isEditable, null, data);
    }

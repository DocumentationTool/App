...
public interface ResourceFunctions {
    ...
    void deleteResource(@Bind("resourcePath") Path resourcePath);
    ...
    /**
     * Updates the path of a resource to the new path (automatically updates all relevant paths duo to triggers generated by {@link com.wonkglorg.docapi.db.daos.DatabaseFunctions#setupTriggers()}
     *

...
public interface ResourceFunctions {
    ...
    int deleteResource(@Bind("resourcePath") Path resourcePath);
    ...
    int deleteData(@Bind("resourcePath") Path resourcePath);
    ...
    @SqlScript("""
            ...
            """)
    int insertResource(@BindMethods Resource resource); //use bind methods instead of bindBean for records as records are not beans
